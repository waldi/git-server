...
function createApp(options) {
  ...
  app.get(
    "/api/repos/:owner/:repo/git/trees/:ref_or_sha(*)",
    treeHandler(options)
  );
  ...
  app.get(
    "/api/repos/:owner/:repo/zipball/:ref(*)?",
    archiveLinkHandler(options, "zip")
  );
  app.get(
    "/api/repos/:owner/:repo/tarball/:ref(*)?",
    archiveLinkHandler(options, "tar.gz")
  );
  app.get(
  ...
  app.get(
    "/codeload/:owner/:repo/legacy.zip/:ref(*)",
    archiveHandler(options, "zip")
  );
  app.get("/codeload/:owner/:repo/zip/:ref(*)", archiveHandler(options, "zip"));
  app.get(
    "/codeload/:owner/:repo/legacy.tar.gz/:ref(*)",
    archiveHandler(options, "tar.gz")
  );
  app.get(
    "/codeload/:owner/:repo/tar.gz/:ref(*)",
    archiveHandler(options, "tar.gz")
  );
...
function createRouter(options) {
  ...
  router.get("/raw/:owner/:repo/:ref/*", rawHandler(options));
  router.get("/:owner/:repo/raw/:ref/*", rawHandler(options));

  router.use("/:owner/:repo.git*", xferHandler(options));

  router.get(
    "/api/repos/:owner/:repo/git/blobs/:file_sha",
    blobHandler(options)
  );
  router.get(
    "/api/repos/:owner/:repo/git/trees/:ref_or_sha(*)",
  ...
  router.get("/api/repos/:owner/:repo/contents*", contentHandler(options));
  ...
  router.get("/:owner/:repo/blob/:ref/*", htmlHandler(options, "blob"));
  router.get("/:owner/:repo/tree/:ref*", htmlHandler(options, "tree"));
  router.get("/:owner/:repo", htmlHandler(options, "root"));
